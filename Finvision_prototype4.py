...
class AIsearch:
    ...
    def main():
        ...
        market_data = input("Enter the list of companies in the market (comma separated and no spaces [for example : x,y,z,etc.]): ").split(',')
    ...
    def main():
        ...
        market_data = NSEcorp  # list of companies in the market
        market_average = calculate_market_average(market_data)
        data = search_internet(company)
        if len(data) < 10:
            print("Cannot evaluate investment currently")
...
class NIFTY500: 
    ...
    strengths = ['Strong financial position', 'Experienced management team', 'Diversified product portfolio']
    weaknesses = ['High debt levels', 'Dependence on few customers', 'Limited international presence']

    # Define the opportunities and threats
    opportunities = ['Growing demand for sustainable products', 'Expansion into new markets', 'Strategic partnerships']
    threats = ['Intense competition', 'Regulatory changes', 'Economic downturn']
...
class StockAnalysis: 
    ...
    for company, data in stock_data.items():
        ...
        print(f"  Float Shares: {data['floatShares']}")
